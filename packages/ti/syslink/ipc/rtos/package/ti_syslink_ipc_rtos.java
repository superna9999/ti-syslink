...
public class ti_syslink_ipc_rtos
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/debug/ti.syslink.ipc.rtos.a64P',\n");
            sb.append("'lib/release/ti.syslink.ipc.rtos.a64P',\n");
            sb.append("'lib/debug/ti.syslink.ipc.rtos.ae64P',\n");
            sb.append("'lib/release/ti.syslink.ipc.rtos.ae64P',\n");
            sb.append("'lib/debug/ti.syslink.ipc.rtos.a674',\n");
            sb.append("'lib/release/ti.syslink.ipc.rtos.a674',\n");
            ...
            sb.append("'lib/debug/ti.syslink.ipc.rtos.aea8f',\n");
            sb.append("'lib/release/ti.syslink.ipc.rtos.aea8f',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ti.syslink.ipc.rtos.a64P', {target: 'ti.targets.C64P', suffix: '64P'}],\n");
            sb.append("['lib/release/ti.syslink.ipc.rtos.a64P', {target: 'ti.targets.C64P', suffix: '64P'}],\n");
            sb.append("['lib/debug/ti.syslink.ipc.rtos.ae64P', {target: 'ti.targets.elf.C64P', suffix: 'e64P'}],\n");
            sb.append("['lib/release/ti.syslink.ipc.rtos.ae64P', {target: 'ti.targets.elf.C64P', suffix: 'e64P'}],\n");
            sb.append("['lib/debug/ti.syslink.ipc.rtos.a674', {target: 'ti.targets.C674', suffix: '674'}],\n");
            sb.append("['lib/release/ti.syslink.ipc.rtos.a674', {target: 'ti.targets.C674', suffix: '674'}],\n");
            ...
            sb.append("['lib/debug/ti.syslink.ipc.rtos.aea8f', {target: 'ti.targets.arm.elf.A8F', suffix: 'ea8f'}],\n");
            sb.append("['lib/release/ti.syslink.ipc.rtos.aea8f', {target: 'ti.targets.arm.elf.A8F', suffix: 'ea8f'}],\n");
        sb.append("];\n");
